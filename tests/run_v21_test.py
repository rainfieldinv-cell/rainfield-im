"""run_v21_test.py — 표 서식 표준(style_table) 적용. 슬1 표 + 슬7 박스 불변 확인."""
...
OUTPUT   = os.path.join(ROOT, "test_ai_builders_v21.pptx")
BIZ = "천안 부성2지구 도시개발사업"
...
def main():
    ...
    print(f"[v21] 중복파트: {'있음 ' + str(dup) if dup else '없음 (정상)'}")
